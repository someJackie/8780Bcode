...
#define LEFT_MOTORS 0,0,0//-1,-5,-3
#define RIGHT_MOTORS 0,0,0//6,8,7
#define GEARSET pros::E_MOTOR_GEAR_200 // RPM of chassis motors

// Ticks per inch
#define TPI 35.258        // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI 1 // Ticks per inch for the middle wheel

// Tracking wheel distances
#define TRACK_WIDTH                                                            \
	10.75 // The distance between left and right wheels (or tracker wheels)
#define MIDDLE_DISTANCE                                                        \
	0 // Distance from middle wheel to the robot turning center

// Sensors
#define IMU_PORT 0                           // Port 0 for disabled
#define ENCODER_PORTS 5, 8, 0                // Port 0 for disabled,
